...
const BatchUploadUsers = ({ onClose, refresh }) => {
    ...
    const downloadTemplateAsset = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/Users List V0.1 (03.03.2026).xlsx`; // Adjust path as needed
        link.setAttribute('download', 'User List V0.1 (03.03.2026).xlsx');
    ...
    const createErrorFile = (errLines) => {
        ...
        a.href = url;
        a.download = `user_batch_errors_${new Date().toISOString().slice(0, 10)}.txt`;
        a.click();
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const url = `${base}/api/batchUsers/batch-register`;
            ...
            if (status === 400 && Array.isArray(data?.details)) {
                ...
                toast.error("Some users failed to register. Error file downloaded.", {
                    closeButton: false,
                    autoClose: 2500,
                    style: { textAlign: 'center' }
                });
        ...
        <div className="batch-popup-overlay-assets">
            <div className="batch-popup-content-assets">
                <div className="batch-file-header">
                    <h2 className="batch-file-title">Batch Register Users</h2>
                ...
                <div className="import-si-file-group" style={{ position: "relative" }}>
                    ...
                    <div className="import-si-file-text">Download User List Template</div>
                    ...
                    <div className="import-si-value">2026-03-03</div>
                </div>

                <div className="batch-file-group-assets">
                    <div className="batch-file-text">Import User List</div>
...
export default BatchUploadUsers;