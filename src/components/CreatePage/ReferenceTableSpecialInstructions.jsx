...
const ReferenceTableSpecialInstructions = ({ collapsible = false, formData, referenceRows, addRefRow, removeRefRow, updateRefRow, updateRefRows, setFormData, readOnly = false }) => {
