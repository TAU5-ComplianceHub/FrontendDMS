...
const OnlineTrainingSortPopupVisitors = ({ setSortField, setSortOrder, closeSortModal, sortField, sortOrder, handleSort }) => {
    return (
        <div className="sort-popup-overlay">
            <div className="sort-popup-content">
                <div className="sort-file-header">
                    <h2 className="sort-file-title">Sort Students</h2>
                ...
                <div className="sort-file-group">
                    ...
                    <div className="sort-files-select-container">
                        ...
                        >
                            ...
                            <option value="courses" style={{ color: "black" }}>Enrolled Courses</option>
                            <option value="completed" style={{ color: "black" }}>Completed Courses</option>
                            <option value="lastCompletion" style={{ color: "black" }}>Last Completion Date</option>
...
export default OnlineTrainingSortPopupVisitors;