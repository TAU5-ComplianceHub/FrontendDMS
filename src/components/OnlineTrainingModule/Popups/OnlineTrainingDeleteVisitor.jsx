...
const OnlineTrainingDeleteVisitor = ({ closeModal, deleteVisitor, name, loading }) => {
    return (
        <div className="delete-popup-overlay">
            <div className="delete-popup-content">
                <div className="delete-file-header">
                    <h2 className="delete-file-title">Delete Student</h2>
...
export default OnlineTrainingDeleteVisitor;