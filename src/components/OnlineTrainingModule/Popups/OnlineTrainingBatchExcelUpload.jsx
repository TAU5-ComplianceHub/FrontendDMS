...
const OnlineTrainingBatchExcelUpload = ({ onClose, refresh }) => {
    ...
    const downloadTemplateAsset = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/TAU5 - Student Group List V0.1 (13.01.2026).xlsx`; // Adjust path as needed
        link.setAttribute('download', 'Student Group List V0.1 (13.01.2026).xlsx');
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const url = `${base}/api/onlineTrainingStudentManagement/importStudentsExcel`;
            ...
            setMessage(response?.data?.message || "Students imported successfully.");
            setErrors([]);
            setFile(null);
            ...
            if (status === 400 && Array.isArray(data?.details)) {
                ...
                toast.error("Some students failed to import. Error file downloaded.", {
                    closeButton: false,
                    autoClose: 2500,
                    style: { textAlign: 'center' }
                });
        ...
        <div className="batch-popup-overlay-assets">
            <div className="batch-popup-content-assets">
                <div className="batch-file-header">
                    <h2 className="batch-file-title">Create Student Group</h2>
                ...
                <div className="import-si-file-group" style={{ position: "relative" }}>
                    ...
                    <div className="import-si-file-text">Download Student Group List Template</div>
                    ...
                    <div className="import-si-value">2026-01-13</div>
                </div>

                <div className="batch-file-group-assets">
                    <div className="batch-file-text">Import Student Group List</div>
...
export default OnlineTrainingBatchExcelUpload;