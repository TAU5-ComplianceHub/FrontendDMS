...
const OnlineTrainingCreateProfilePopup = ({ onClose, refresh, openUserLinkShare }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(
                `${process.env.REACT_APP_URL}/api/onlineTrainingStudentManagement/createStudentProfile`,
                {
                    name: name.trim(),
...
export default OnlineTrainingCreateProfilePopup;