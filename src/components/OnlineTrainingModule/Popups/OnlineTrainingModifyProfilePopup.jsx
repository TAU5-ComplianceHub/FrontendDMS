...
const OnlineTrainingModifyProfilePopup = ({ onClose, refresh, data }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(
                `${process.env.REACT_APP_URL}/api/onlineTrainingStudentManagement/modifyStudent/${userID}`,
                {
                    name: name.trim(),
            ...
            toast.success(message || 'Student Profile Updated', { autoClose: 800, closeButton: false });

            console.log("New student updated:", user);

            refresh();
            onClose?.();
        } catch (err) {
            const status = err?.response?.status;
            const msg = err?.response?.data?.error || 'Failed to update student profile.';
                                    ...
                                    <div className="create-visitor-profile-page-column-half">
                                        <div className="create-visitor-profile-page-component-wrapper">
                                            <div className="create-visitor-profile-page-form-group">
                                                ...
                                                <input
                                                    className="cea-popup-page-input"
                                                    placeholder="Insert Student Surname"
                                    ...
                                    <div className="create-visitor-profile-page-column-half">
                                        <div className="create-visitor-profile-page-component-wrapper">
                                            <div className="create-visitor-profile-page-form-group">
                                                ...
                                                <input
                                                    type='text'
                                                    placeholder='Insert Student Company Name'
                                                    className="cea-popup-page-input"
...
export default OnlineTrainingModifyProfilePopup;