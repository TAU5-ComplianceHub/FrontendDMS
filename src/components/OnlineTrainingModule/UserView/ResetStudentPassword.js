...
function ResetStudentPassword() {
    ...
    const handleLogin = async (e) => {
        ...
        if (step === 1) {
            try {
                const response = await fetch(`${process.env.REACT_APP_URL}/api/onlineTrainingStudentManagement/request-student-reset-otp`, {
                    method: 'POST',
                    headers: {
            ...
            try {
                const response = await fetch(`${process.env.REACT_APP_URL}/api/onlineTrainingStudentManagement/verify-student-reset-otp`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
            ...
            try {
                const response = await fetch(`${process.env.REACT_APP_URL}/api/onlineTrainingStudentManagement/reset-student-password`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    ...
                    {step === 2 && (
                        <>
                            ...
                            >
                                ...
                                <br />Please enter the OTP below to access your Student Profile.
                            </label>
