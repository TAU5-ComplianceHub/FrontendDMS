const StudentInvalidPageMobile = () => {
    return (
        <div className="invalid-page-class-container" style={{ fontFamily: "Arial" }}>
            <div className="invalid-page-class-card">
                ...
                <p className="invalid-page-class-message" style={{ marginTop: "auto", marginBottom: "auto" }}>
                    This student profile link cannot be accessed from a mobile device. Please use a desktop browser to complete the induction.
                </p>
            </div>
...
export default StudentInvalidPageMobile;