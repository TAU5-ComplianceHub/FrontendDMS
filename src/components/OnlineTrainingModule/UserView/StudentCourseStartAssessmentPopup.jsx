...
const StudentCourseStartAssessmentPopup = ({ closeModal, startAssessment }) => {
    return (
        <div className="delete-popup-overlay">
            <div className="delete-popup-content">
                ...
                <div className="delete-file-group-startAssessment">
                    <div className="delete-file-text-startAssessment">{"Once you start the assessment, the Course material will no longer be accessible. Would you like to proceed or review the material first?"}</div>
                </div>
...
export default StudentCourseStartAssessmentPopup