...
const StudentOTPLink = ({ userID, otpCompleted, setOtpCompleted, setStudent, resendOTP }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(
                `${process.env.REACT_APP_URL}/api/onlineTrainingStudentManagement/verify-student-otp/${userID}`,
                {
                    method: 'POST',
            ...
            <div className="nl-login-container-otp">
                <div className="nl-login-card">
                    ...
                    >
                        ...
                        <br />Please insert it below to access your Student Profile.
                    </label>
