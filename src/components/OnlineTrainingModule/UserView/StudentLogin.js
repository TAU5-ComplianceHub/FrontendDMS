...
const StudentLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/onlineTrainingStudentManagement/login`, {
                method: 'POST',
            ...
            <div className="nl-login-card">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="nl-options-row" style={{ marginBottom: "5px" }}>
                        <a onClick={() => navigate("/FrontendDMS/resetStudentPassword")} className="nl-forgot-password-visitor">Reset Password</a>
                    </div>
