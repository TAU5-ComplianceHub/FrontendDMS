        ...
        <div className="course-home-info-container">
            ...
            <div className="main-box-course-home-info">
                <div className="top-section-um">
                    ...
                    <TopBar student={true} viewQRCode={viewCode} />
                </div>
                <div className="course-home-info-wrapper">
                    {/* Welcome header (avatar + name) */}
                    <div className="course-home-info-topbar">
                        <div className="course-home-info-avatar">{getStudentInitials()}</div>
                        <div className="course-home-info-welcome">Welcome Back, {getStudentName()}!</div>
                    </div>
                            ...
                            <table className="course-home-info-table">
                                <thead className="course-home-info-head">
                                    <tr className="course-home-info-tr">
                                        ...
                                        <th className="course-home-info-code" style={{ width: "25%" }}>Course Name</th>
                                        ...
                                        <th className="course-home-info-access" style={{ width: "15%" }}>Course Expiry Date</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {filtered
