...
import { faDownload, faMagicWandSparkles, faSpinner, faRotateLeft, faChevronDown, faChevronUp } from "@fortawesome/free-solid-svg-icons";
...
const InductionOutline = ({ collapsible = false, formData, setFormData, readOnly = false }) => {
