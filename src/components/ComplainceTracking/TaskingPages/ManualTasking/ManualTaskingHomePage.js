        ...
        <div className="dc-info-container">
            ...
            <div className="main-box-dc">
                ...
                <div className="scrollable-box-dc-home">
                    <div className={`document-card-dc-home`} onClick={() => navigate("/FrontendDMS/manualTaskingAllocate")}>
                        <>
                            <div className="icon-dc">
                                <FontAwesomeIcon icon={faCircle} style={{ color: "#002060" }} src={"/proceduresDMS.svg"} className={"icon-dc"} />
                            </div>
                            <h3 className="document-title-dc-home">Allocate Tasks</h3>
                        </>
                    </div>
                    <div className={`document-card-dc-home`} onClick={() => navigate("/FrontendDMS/manualTaskingTasks")}>
                        <>
                            <div className="icon-dc">
                                <FontAwesomeIcon icon={faCircle} style={{ color: "#002060" }} src={"/standardsDMS.svg"} className={"icon-dc"} />
                            </div>
                            <h3 className="document-title-dc-home">Update My Tasks</h3>
                        </>
                    </div>
                </div>
            </div>
...
export default ManualTaskingHomePage;