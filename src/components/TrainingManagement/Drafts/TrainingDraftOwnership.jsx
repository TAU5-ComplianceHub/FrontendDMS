...
const TrainingDraftOwnership = ({ onClose, creatorName, creatorID, draftType, draftTitle, draftID, refresh }) => {
    ...
    const handleClick = async () => {
        ...
        try {
            const response = await axios.post(
                `${process.env.REACT_APP_URL}/api/onlineTrainingCourses/transferDraft`,
                {
...
export default TrainingDraftOwnership;